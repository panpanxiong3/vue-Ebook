<template>
  <div class="ebook-slide-bookmark">
    ...
    <scroll class="slide-bookmark-list" :top="42" :bottom="20.5">
      <div class="slide-bookmark-item" v-for="(item, index) in bookmark" :key="index" @click="clickDisplay(item.cfi)">
